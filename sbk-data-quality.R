# Data Quality processing for Stationary (SBK)
...
file.to.score <- "WIP/SBK_WIP.csv"
file.to.compare <- "Original Data/SBK_Original.csv"
...
if(e == 'Laptop') {
      ...
      wip.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/SBK/WIP/"
      csf.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/SBK/CSF Files/"
      sbk.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/SBK/"
      }

if(e == 'C Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "C:/Users/oakleya/Desktop/Data Cleanse/SBK/"
}

if(e == 'R Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "R:/Data Quality Reports/Data Cleanse/SBK/"
}
...
psa1.products <- read.csv(paste(sbk.dir,file.to.score,sep=""))
psa1.original <- read.csv(paste(sbk.dir,file.to.compare,sep=""))
...
#------------------------------------------------------------------------------------------------------------------------------
write.csv(dq.data.file,paste(wip.dir,"SBK_DQ_Data.csv",sep = ""),row.names = FALSE, quote = TRUE)
#------------------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------------------
#compare.attributes(psa1.original,psa1.products,"SBK")
#------------------------------------------------------------------------------------------------------------------------------
#