# Data Quality processing for Housewares (HOU)
...
file.to.score <- "WIP/HOU_WIP.csv"
file.to.compare <- "Original Data/HOU_Original.csv"
...
if(e == 'Laptop') {
      ...
      wip.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/HOU/WIP/"
      csf.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/HOU/CSF Files/"
      hou.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/HOU/"
      }

if(e == 'C Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "C:/Users/oakleya/Desktop/Data Cleanse/HOU/"
}

if(e == 'R Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "R:/Data Quality Reports/Data Cleanse/HOU/"
}
...
psa1.products <- read.csv(paste(hou.dir,file.to.score,sep=""))
psa1.original <- read.csv(paste(hou.dir,file.to.compare,sep=""))
...
#------------------------------------------------------------------------------------------------------------------------------
write.csv(dq.data.file,paste(wip.dir,"HOU_DQ_Data.csv",sep = ""),row.names = FALSE, quote = TRUE)
#------------------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------------------
#compare.attributes(psa1.original,psa1.products,"HOU")
#------------------------------------------------------------------------------------------------------------------------------
#