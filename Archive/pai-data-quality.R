# Data Quality processing for Paint (PAI)
...
file.to.score <- "WIP/PAI_WIP.csv"
file.to.compare <- "Original Data/PAI_Original.csv"
...
if(e == 'Laptop') {
      ...
      wip.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/PAI/WIP/"
      csf.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/PAI/CSF Files/"
      pai.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/PAI/"
      }

if(e == 'C Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "C:/Users/oakleya/Desktop/Data Cleanse/PAI/"
}

if(e == 'R Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "R:/Data Quality Reports/Data Cleanse/PAI/"
}
...
psa1.products <- read.csv(paste(pai.dir,file.to.score,sep=""))
psa1.original <- read.csv(paste(pai.dir,file.to.compare,sep=""))
...
#------------------------------------------------------------------------------------------------------------------------------
write.csv(dq.data.file,paste(wip.dir,"PAI_DQ_Data.csv",sep = ""),row.names = FALSE, quote = TRUE)
#------------------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------------------
#compare.attributes(psa1.original,psa1.products,"PAI")
#------------------------------------------------------------------------------------------------------------------------------
#