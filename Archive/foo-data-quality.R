# Data Quality processing for Food (FOO)
...
file.to.score <- "WIP/FOO_WIP.csv"
file.to.compare <- "Original Data/FOO_Original.csv"
...
if(e == 'Laptop') {
      ...
      wip.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/FOO/WIP/"
      csf.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/FOO/CSF Files/"
      foo.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/FOO/"
      }

if(e == 'C Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "C:/Users/oakleya/Desktop/Data Cleanse/FOO/"
}

if(e == 'R Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "R:/Data Quality Reports/Data Cleanse/FOO/"
}
...
psa1.products <- read.csv(paste(foo.dir,file.to.score,sep=""))
psa1.original <- read.csv(paste(foo.dir,file.to.compare,sep=""))
...
#------------------------------------------------------------------------------------------------------------------------------
write.csv(dq.data.file,paste(wip.dir,"FOO_DQ_Data.csv",sep = ""),row.names = FALSE, quote = TRUE)
#------------------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------------------
#compare.attributes(psa1.original,psa1.products,"FOO")
#------------------------------------------------------------------------------------------------------------------------------
#