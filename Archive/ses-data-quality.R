# Data Quality processing for Seasonal Products (SES)
...
file.to.score <- "WIP/SES_WIP.csv"
file.to.compare <- "Original Data/SES_Original.csv"
...
if(e == 'Laptop') {
      ...
      wip.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/SES/WIP/"
      csf.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/SES/CSF Files/"
      ses.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/SES/"
      }

if(e == 'C Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "C:/Users/oakleya/Desktop/Data Cleanse/SES/"
}

if(e == 'R Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "R:/Data Quality Reports/Data Cleanse/SES/"
}
...
psa1.products <- read.csv(paste(ses.dir,file.to.score,sep=""))
psa1.original <- read.csv(paste(ses.dir,file.to.compare,sep=""))
...
#------------------------------------------------------------------------------------------------------------------------------
write.csv(dq.data.file,paste(wip.dir,"SES_DQ_Data.csv",sep = ""),row.names = FALSE, quote = TRUE)
#------------------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------------------
#compare.attributes(psa1.original,psa1.products,"SES")
#------------------------------------------------------------------------------------------------------------------------------
#