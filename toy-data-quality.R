# Data Quality processing for Toys (TOY)
...
file.to.score <- "WIP/TOY_WIP.csv"
file.to.compare <- "Original Data/TOY_Original.csv"
...
if(e == 'Laptop') {
      ...
      wip.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/TOY/WIP/"
      csf.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/TOY/CSF Files/"
      toy.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/TOY/"
      }

if(e == 'C Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "C:/Users/oakleya/Desktop/Data Cleanse/TOY/"
}

if(e == 'R Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "R:/Data Quality Reports/Data Cleanse/TOY/"
}
...
psa1.products <- read.csv(paste(toy.dir,file.to.score,sep=""))
psa1.original <- read.csv(paste(toy.dir,file.to.compare,sep=""))
...
#------------------------------------------------------------------------------------------------------------------------------
write.csv(dq.data.file,paste(wip.dir,"TOY_DQ_Data.csv",sep = ""),row.names = FALSE, quote = TRUE)
#------------------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------------------
#compare.attributes(psa1.original,psa1.products,"TOY")
#------------------------------------------------------------------------------------------------------------------------------
#