# Data Quality processing for Decorating (DEC)
...
file.to.score <- "WIP/DEC_WIP.csv"
file.to.compare <- "Original Data/DEC_Original.csv"
...
if(e == 'Laptop') {
      ...
      wip.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/DEC/WIP/"
      csf.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/DEC/CSF Files/"
      dec.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/DEC/"
      }

if(e == 'C Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "C:/Users/oakleya/Desktop/Data Cleanse/DEC/"
}

if(e == 'R Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "R:/Data Quality Reports/Data Cleanse/DEC/"
}
...
psa1.products <- read.csv(paste(dec.dir,file.to.score,sep=""))
psa1.original <- read.csv(paste(dec.dir,file.to.compare,sep=""))
...
#------------------------------------------------------------------------------------------------------------------------------
write.csv(dq.data.file,paste(wip.dir,"DEC_DQ_Data.csv",sep = ""),row.names = FALSE)
#------------------------------------------------------------------------------------------------------------------------------
