...
file.to.score <- "WIP/KIT_WIP.csv"
file.to.compare <- "Original Data/KIT_Original.csv"
...
if(e == 'Laptop') {
      ...
      wip.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/KIT/WIP/"
      csf.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/KIT/CSF Files/"
      kit.dir <- "D:/OneDrive/Work Files/Wilko/Data Cleanse/KIT/"
      }

if(e == 'C Drive') {
      
      setwd("C:/Users/oakleya/Desktop/R Projects/wilko.com/Scripts")
      wip.dir <- "C:/Users/oakleya/Desktop/Data Cleanse/KIT/"
}
...
psa1.products <- read.csv(paste(kit.dir,file.to.score,sep=""))
psa1.original <- read.csv(paste(kit.dir,file.to.compare,sep=""))

#------------------------------------------------------------------------------------------------------------------------------

# Create RegEx for Attribute Columns checks by PSA1 (KIT)
...
psa1.products <- dq.score.size.format(psa1.products,paste(check.size))
...
#------------------------------------------------------------------------------------------------------------------------------
#compare.attributes(psa1.original,psa1.products,"KIT")
#------------------------------------------------------------------------------------------------------------------------------
#