...
# Set up Working Directories, Source Scripts and Target files
      ...
      file.to.compare <- paste("Master Data File/SAP Checks/",psa1,"_SAP.csv",sep ="")
      
      wip.dir <- paste("D:/OneDrive/Work Files/Wilko/Data Cleanse/",psa1,"/WIP/",sep = "")
      csf.dir <- paste("D:/OneDrive/Work Files/Wilko/Data Cleanse/",psa1,"/CSF Files/",sep = "")
      toi.dir <- paste("D:/OneDrive/Work Files/Wilko/Data Cleanse/",psa1,"/",sep = "")
